...
def _payload() -> dict[str, object]:
    ...
    return {
        ...
        "dataset": {
            ...
            "split": "val",
            "image_count": 10_000,
            "images_package_md5": "5a0359c86a0b8713adab1eee9a3041cb",
            "labels_package_md5": "b86a3e1b7edbcad421b7dad2b3987c94",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (("dataset", "image_count"), 9_999, "image_count"),
        (("dataset", "images_package_md5"), "f" * 32, "images_package_md5"),
        (("dataset", "labels_package_md5"), "f" * 32, "labels_package_md5"),
